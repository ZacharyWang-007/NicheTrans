...
from utils.SMA_utils_training import train, test
...
def main():
    ...
    dataset = SMA(path_img='/home/wzk/ST_data/SMA_data/Processed/patches', n_top_genes=args.n_source, n_top_targets=args.n_target)
    ...
    for epoch in range(args.max_epoch):
        ...
        torch.save(model.state_dict(), './save_models/{}.pth'.format(str(epoch+1)))
